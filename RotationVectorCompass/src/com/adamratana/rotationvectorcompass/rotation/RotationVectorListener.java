...
/**
 * Uses the new (Android 2.3+) Rotation Vector virtual sensor, which is a sensor fusion of the magnetometer, accelerometer, and gyroscope (if present)
 * Note: this does not seem to function correctly for Samsung Galaxy Tab 10.1, in that North does not point North
 * 
