 ...
 * to it self in all modification methods.
 * 
...
public final class Vector3 {
	...
	public Vector3 mul(Matrix matrix) {
		...
		return this.set(x * l_mat[Matrix.M00] + y * l_mat[Matrix.M01] + z * l_mat[Matrix.M02] + l_mat[Matrix.M03], x * l_mat[Matrix.M10] + y * l_mat[Matrix.M11] + z * l_mat[Matrix.M12] + l_mat[Matrix.M13], x * l_mat[Matrix.M20] + y * l_mat[Matrix.M21]
				+ z * l_mat[Matrix.M22] + l_mat[Matrix.M23]);
	}
	...
	public Vector3 prj(Matrix matrix) {
		...
		return this.set((x * l_mat[Matrix.M00] + y * l_mat[Matrix.M01] + z * l_mat[Matrix.M02] + l_mat[Matrix.M03]) / l_w, (x * l_mat[Matrix.M10] + y * l_mat[Matrix.M11] + z * l_mat[Matrix.M12] + l_mat[Matrix.M13]) / l_w, (x * l_mat[Matrix.M20] + y
				* l_mat[Matrix.M21] + z * l_mat[Matrix.M22] + l_mat[Matrix.M23])
				/ l_w);
	}
	...
	public Vector3 rot(Matrix matrix) {
		float l_mat[] = matrix.val;
		return this.set(x * l_mat[Matrix.M00] + y * l_mat[Matrix.M01] + z * l_mat[Matrix.M02], x * l_mat[Matrix.M10] + y * l_mat[Matrix.M11] + z * l_mat[Matrix.M12], x * l_mat[Matrix.M20] + y * l_mat[Matrix.M21] + z * l_mat[Matrix.M22]);
	}
