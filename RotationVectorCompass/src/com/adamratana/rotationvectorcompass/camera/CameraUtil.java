...
public class CameraUtil {
    ...
    /**
     * gets the correct rotation of the camera for the surface rotation requested, adjust for front/back camera
...
//	
//	/**
//	 * rotate an array from width/height to newWidth/newHeight - ie, rotate an image by say 90 degrees
//	 * @param inArray
//	 * @param width
//	 * @param height
//	 * @param newWidth
...
//	 * @param outArray
//	 */
//	public static void rotateArray(int[] inArray, int width, int height, int newWidth, int newHeight, int rotation, int[] outArray) {		
//		if (rotation == 0) {
//			return;
//		}
//		// width and height must either be the same, or swapped, but nothing else.
//		if ((
